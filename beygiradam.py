...
st.set_page_config(page_title="BEYGİR ADAM | V47", layout="wide")

st.markdown("<h1 style='text-align:center; color:#FF8C00;'>🏇 BEYGİR ADAM v47.0</h1>", unsafe_allow_html=True)
